...
export default function Login() {
 ...
 const handleLogin = async () => {
  ...
  try {
    ...
    // fake token just for session
    const token = "supabase-session";
            ...
            <div className="group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full border-2 border-slate-100 bg-slate-50/50 pl-11 pr-5 py-3.5 rounded-2xl outline-none focus:ring-4 focus:ring-teal-500/5 focus:border-teal-500 focus:bg-white transition-all font-medium text-slate-800"
                />
              </div>
            </div>
